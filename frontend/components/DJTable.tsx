...
// Canvas dimensions — all coordinates below are in this pixel space
const W = 1920
const H = 1080
...
export default function DJTable() {
  ...
  useEffect(() => {
    const calc = () => {
      ...
      // Scale canvas to fill viewport width; letterbox top/bottom if needed
  ...
  return (
    <div style={{ position: "relative", width: "100vw", height: "100vh", overflow: "hidden", background: "#14100a" }}>
      {/*
       * Fixed 1920×1080 canvas, centered, scaled to fill viewport width.
       * All child positions are in 1920×1080 pixel space.
       */}
      <div style={{
        position: "absolute",
        width: W,
        ...
        {/* Background — stretches exactly over the canvas */}
        <div style={{
          position: "absolute",
          inset: 0,
        ...
        {/* ── FLYER PAGE BUTTON ─────────────────────────────────────
         *  x=220.4  y=31.7  w=353.7  h=123.3  rot=0°
         * ─────────────────────────────────────────────────────────── */}
        <Link href="/flyers" style={{
          position: "absolute",
          left: 220.4, top: 31.7, width: 353.7, height: 123.3,
          zIndex: 30,
          display: "block",
        }} aria-label="View flyers" />

        {/* ── PHONE MEDIA PLAYER ────────────────────────────────────
         *  x=739.4  y=81.7  w=335.9  h=157.1  rot=5.2°
         * ─────────────────────────────────────────────────────────── */}
        <div style={{
          position: "absolute",
          left: 739.4, top: 81.7, width: 335.9, height: 157.1,
        ...
        {/* ── POLAROID ──────────────────────────────────────────────
         *  x=1583.1  y=62.2  w=210.7  h=216.7  rot=-17°
         * ─────────────────────────────────────────────────────────── */}
        <div style={{
          position: "absolute",
          left: 1583.1, top: 62.2, width: 210.7, height: 216.7,
        ...
        {/* ── SOUNDCLOUD ────────────────────────────────────────────
         *  x=434.7  y=382.5  w=332.4  h=195.6  rot=0°
         * ─────────────────────────────────────────────────────────── */}
        <div style={{
          position: "absolute",
          left: 434.7, top: 382.5, width: 332.4, height: 195.6,
          overflow: "hidden",
          borderRadius: 4,
        }}>
          <iframe
        ...
        {/* ── iPAD ──────────────────────────────────────────────────
         *  x=1283  y=362.3  w=449  h=596.2  rot=-3.6°
         * ─────────────────────────────────────────────────────────── */}
        <div style={{
          position: "absolute",
          left: 1283, top: 362.3, width: 449, height: 596.2,
...
function MobileScene({ settings, embedUrl }: { settings: Settings; embedUrl: string }) {
  return (
    <div style={{
      minHeight: "100vh", background: "#1a120a",
      display: "flex", flexDirection: "column", alignItems: "center",
      padding: "20px 16px 40px", gap: 20,
    }}>
      <div style={{
        display: "flex", alignItems: "center", justifyContent: "space-between",
        width: "100%", maxWidth: 480,
      }}>
        <img src="/osos-sticker.png" alt="Osos Discos"
      ...
      <div style={{
        width: "100%", maxWidth: 480, height: 380,
        borderRadius: 12, overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.5)",
      }}>
        <DJTableIPad />
      </div>
